  ...
  return (
    <>
      ...
      <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
        {/* ── Brand Header ── */}
        <div className="flex items-center justify-between px-4 py-4 border-b border-white/[0.08] bg-slate-950/50">
          <div
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-semibold text-amber-400/80 tracking-wider uppercase mt-1">
                Smart Governance
              </span>
            </div>
          </div>
